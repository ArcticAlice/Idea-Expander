...
let starData = localStorage.getItem('leoArray');
...
function creatingStarData() {
    if (starData) {
        ...
        starData = [
            { cx: 260, cy: 680, colored: false, color: 'gray', text: '' },
            { cx: 480, cy: 610, colored: false, color: 'gray', text: '' },
            { cx: 420, cy: 420, colored: false, color: 'gray', text: '' },
            { cx: 950, cy: 530, colored: false, color: 'gray', text: '' },
            { cx: 920, cy: 340, colored: false, color: 'gray', text: '' },
            { cx: 750, cy: 260, colored: false, color: 'gray', text: '' },
            { cx: 720, cy: 160, colored: false, color: 'gray', text: '' }, 
            { cx: 900, cy: 40, colored: false, color: 'gray', text: '' },
            { cx: 1000, cy: 120, colored: false, color: 'gray', text: '', animated: false },
          ];
...
saveButton.addEventListener('click', () => {
    ...
    localStorage.setItem("leoArray", JSON.stringify(starData));
