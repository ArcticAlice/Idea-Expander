...
let starData = localStorage.getItem('taurusArray');
...
function creatingStarData() {
    if (starData) {
        ...
        starData = [
            { cx: 1200, cy: 650, colored: false, color: 'gray', text: '' },
            { cx: 900, cy: 480, colored: false, color: 'gray', text: '' },
            { cx: 800, cy: 430, colored: false, color: 'gray', text: '' },
            { cx: 750, cy: 320, colored: false, color: 'gray', text: '' },
            { cx: 630, cy: 330, colored: false, color: 'gray', text: '' },
            { cx: 470, cy: 210, colored: false, color: 'gray', text: '' },
            { cx: 110, cy: 70, colored: false, color: 'gray', text: '' }, // end
            { cx: 700, cy: 480, colored: false, color: 'gray', text: '' },
            { cx: 550, cy: 480, colored: false, color: 'gray', text: '' },
            { cx: 100, cy: 330, colored: false, color: 'gray', text: '', animated: false },
          ];
...
function animateLines() {
    ...
    const connectionGroups = [
        ...
        // Group 2 (Parallel animation starts here): Star 2 → Star 3, Star 2 → Star 7
        [{ from: 2, to: 3 }, { from: 2, to: 7 }],
        // Group 3: Sequential branches
        [{ from: 3, to: 4 }, { from: 7, to: 8 }],
        [{ from: 4, to: 5 }, { from: 8, to: 9 }],
        [{ from: 5, to: 6 }]
    ];
    ...
    function animateNextGroup() {
        ...
        const parallel = groupIndex === 1 || groupIndex === 2 || groupIndex === 3; // Parallel animation at groupIndex 1
...
saveButton.addEventListener('click', () => {
    ...
    localStorage.setItem("taurusArray", JSON.stringify(starData));
