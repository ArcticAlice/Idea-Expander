...
function creatingStarData() {
    if (starData) {
        ...
        starData = [
            { cx: 200, cy: 650, colored: false, color: 'gray', text: '' },
            { cx: 250, cy: 540, colored: false, color: 'gray', text: '' },
            { cx: 350, cy: 480, colored: false, color: 'gray', text: '' }, 
            { cx: 310, cy: 360, colored: false, color: 'gray', text: '' },
            { cx: 180, cy: 250, colored: false, color: 'gray', text: '' },
            { cx: 500, cy: 160, colored: false, color: 'gray', text: '' },
            { cx: 620, cy: 180, colored: false, color: 'gray', text: '' },
            { cx: 600, cy: 260, colored: false, color: 'gray', text: '' },
            { cx: 750, cy: 280, colored: false, color: 'gray', text: '' },
            { cx: 630, cy: 460, colored: false, color: 'gray', text: '' },
            { cx: 670, cy: 600, colored: false, color: 'gray', text: '' },
            { cx: 870, cy: 500, colored: false, color: 'gray', text: '' },
            { cx: 1100, cy: 680, colored: false, color: 'gray', text: '', animated: false },
          ];
